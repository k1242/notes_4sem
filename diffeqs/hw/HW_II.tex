...
найдём характерестическую систему уравнения \ref{17.}.
\begin{equation*}
    \begin{cases}
...
\end{gather*}
Ответ:\\
 Oбщее решение \ref{17.}: $F[U_1(x,y,z),U_2(x,y,z)]$ где $F$ - любая непрерывно дифференцируемая функция, $U_1(x,y,z)=, U_2(x,y,z)=$.\\
 Pешение ЗК \ref{17.}: $u=$
