...
\end{equation}
 ...
 \begin{gather*}
    ...
    \int_1^2 \underbrace{\left( -2 y'(x)-2 x y''(x)+2 \right)}_{=0} h \cdot dx + h^2(2)/2\\
    \Delta J = \int_1^2 \left(x h'^2 \right)dx + h^2(2)/2
 % \end{gather*}                                               
...
Ответ: \\
$\hat y = x-\frac{6 \ln (x)}{2+\ln (2)}$  абсолютный минимум с вариацией $\Delta J = J(\hat y + h) - J(\hat y) =\int_1^2 \left(x h'^2 \right)dx + h^2(2)/2$ 
