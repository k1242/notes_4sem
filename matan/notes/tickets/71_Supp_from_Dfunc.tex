...
Будем говорить, что для открытого $U \subset \mathcal{R}$ обобщенная функция $\lambda\big|_U = 0$, если $\forall \varphi \in \mathcal{D}(\mathcal{R})\colon \lambda(\varphi) = 0$
